...
export default function Navbar() {
    ...
    // Content page nav (NarrativeOS definition, Compare pages)
                    ...
                    {mobileMenuOpen && (
                        ...
                        >
                            <nav className="container flex flex-col py-12">
                                {contentPageNavItems.map((item, index) => (
                                    <motion.div
                                        key={item.name}
                                ...
                                <motion.div
                                    initial={{ opacity: 0, x: -30 }}
                                    animate={{ opacity: 1, x: 0 }}
                                    transition={{ delay: contentPageNavItems.length * 0.1 }}
                                    className="pt-12"
                                >
                                    <a
                                        href="https://calendly.com/book-crc/storyline/"
