                    ...
                    >
                        ...
                        <div className="relative z-10">
                            <div className="flex items-center gap-3 mb-8 sm:mb-10">
                                ...
                                <span className="text-[#22C55E] font-medium uppercase tracking-[0.1em] text-xs sm:text-sm">System-Led Company</span>
                            </div>
                            <ul className="space-y-4 sm:space-y-6">
                                {[
                                    ...
                                    <li key={item} className="flex gap-4 text-white text-base sm:text-lg">
                    ...
                    >
                        ...
                        <div className="relative z-10">
                            <div className="flex items-center gap-3 mb-8 sm:mb-10">
                                ...
                                <span className="text-text-secondary font-medium uppercase tracking-[0.1em] text-xs sm:text-sm">Founder-Dependent Company</span>
                            </div>
                            <ul className="space-y-4 sm:space-y-6">
                                {[
                                    ...
                                    <li key={item} className="flex gap-4 text-text-secondary text-base sm:text-lg">
