            ...
            <ScrollFade className="container-width relative z-10">
                <div className="max-w-5xl md:mx-auto md:text-center">
                    ...
                    <h2 className="text-3xl sm:text-4xl md:text-6xl text-white font-medium tracking-tighter mb-6 sm:mb-8 max-w-3xl md:mx-auto">
                        ...
                        <span className="text-white/40">Because The <span className="text-[#F36901]">System Is You</span>.</span>
                    </h2>

                    <p className="text-lg sm:text-xl md:text-2xl text-white leading-relaxed max-w-4xl mb-6 font-light md:mx-auto">
                        The Room Test: <span className="font-bold">Can your sales team consistently articulate your value proposition—in a way that resonates with buyers—without you in the room?</span>
                    </p>
                    <p className="text-lg sm:text-xl md:text-2xl text-white leading-relaxed max-w-4xl mb-12 sm:mb-16 font-light md:mx-auto">
                        If the answer is no, you have <span className="font-bold">StoryLock</span>—the structural condition where the story that closes deals lives only in you. Not a talent problem. A transfer problem.
                    </p>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-20 mt-12 sm:mt-16 text-left">
                        ...
                        <div className="space-y-3 sm:space-y-4 border-l-2 border-accent-purple pl-6 sm:pl-8 py-2">
                            ...
                            <p className="text-base sm:text-lg md:text-2xl text-text-secondary leading-relaxed font-light">
                                A systems gap is hiding inside a talent search. The story already wins when you tell it—no hire can carry it until it&apos;s codified into something they can run.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8 border-t border-white/10 pt-10 sm:pt-12 mt-12 sm:mt-16">
                        {[
                            {
                                title: "70%",
                                desc: <>of first VP of Sales hires don&apos;t make it past year one (SaaStr)</>
                            },
                            {
                                title: "50%",
                                desc: "structural close-rate advantage you have over your best hire (Marvell)"
                            },
                            {
                                title: "9-12 mo.",
                                desc: "average ramp time before a new hire carries full quota (Brooks Group)"
                            }
                        ].map((prob, i) => (
