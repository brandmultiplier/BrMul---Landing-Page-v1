        ...
        <section ref={sectionRef} id="trap" className="section-spacing bg-bg-page relative">
            <ScrollFade className="container-width relative z-10">
                <div className="max-w-5xl mx-auto text-center">
                    ...
                    <h2 className="text-3xl sm:text-4xl md:text-6xl text-white font-medium tracking-tighter mb-6 sm:mb-8 max-w-3xl mx-auto">
                        You&apos;re In Every Deal. <br />
                        <span className="text-white/40">That&apos;s The <span className="text-[#F36901]">Problem</span>.</span>
                    </h2>

                    <p className="text-lg sm:text-xl md:text-2xl text-white leading-relaxed max-w-4xl mb-12 sm:mb-16 font-light mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-20 mt-12 sm:mt-16">
                        <div className="space-y-3 sm:space-y-4 border-t-2 border-white/10 pt-6 sm:pt-8">
                        ...
                        <div className="space-y-3 sm:space-y-4 border-t-2 border-accent-purple pt-6 sm:pt-8">
