...
.vsl-player__stage{position:absolute;inset:0}
...
.vsl-player:fullscreen .vsl-player__stage,
.vsl-player:-webkit-full-screen .vsl-player__stage,
.vsl-player.is-fs .vsl-player__stage{
